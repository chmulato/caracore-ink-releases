...
> **Canal público de download:** [`v2.0.0`](https://github.com/chmulato/caracore-ink-releases/releases/tag/v2.0.0) — distribuições publicadas para Windows (Setup + Portable), macOS (DMG) e Linux (DEB), com runtime Java 21 embutido.
...
✅ **Interface Moderna** - Aplicação Desktop com JavaFX 21, design responsivo, paleta de cores profissional, navegação intuitiva.
